...
public class Ventana extends javax.swing.JFrame {
    ...
    public Ventana(botTelegram bot) {
        this.bot = bot;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        primer_plato = jTextField1.getText();
        segundo_plato = jTextField2.getText();
        postre = jTextField3.getText();
        bot.cambiarMenu(primer_plato, segundo_plato, postre);
...
/*        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana(bot).setVisible(true);
            }
        });
        */
    }
