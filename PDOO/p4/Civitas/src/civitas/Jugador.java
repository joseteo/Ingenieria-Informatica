...
public class Jugador implements Comparable<Jugador> {
    ...
    /*private*/ protected Boolean puedeComprar;
    private float saldo;
    ...
    /*package*/ /*protected*/ Boolean recibe(float cantidad){
        Boolean resultado = false;
        if (!encarcelado){
            resultado = modificarSaldo(cantidad);
            Diario.getInstance().ocurreEvento("El jugador "+nombre+" recibe "+cantidad+" euros");
        }
        return resultado;
    }
