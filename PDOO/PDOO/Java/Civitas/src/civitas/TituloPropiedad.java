...
public class TituloPropiedad {
    ...
    public String toString(){
        return "TituloPropiedad { nombre=" + nombre + ", hipotecada=" 
                + hipotecado + ", precio de compra=" + precioCompra + ", alquilerBase=" 
                + alquilerBase + ", factorRevalorizacion=" + factorRevalorizacion 
                + ", hipotecaBase=" + hipotecaBase + ", precioEdificar=" 
                + precioEdificar + ", numero de hoteles=" + numHoteles +
